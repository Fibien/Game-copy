...
void addEntities(){
    ...
    // create HUD
   std::shared_ptr<HUD> hud = ScoreBoard::getInstance(20, 20, 100, 80, ses.getTexture("ScoreBoard"), 2, 2, 1);
   hud->setText("TJENA HÄR SKRIVS NÅGOT LÅ", 40, "./images/fonts/consola.ttf");
